            ...
            <div class="text-center">
              <div class="mb-4">
                <img
                  :src="qrCode"
                  alt="QR Code"
                  class="mx-auto w-48 h-48 border border-gray-300 rounded"
                />
              </div>
              <div class="mb-4">
...
const createWallet = () => {
  const wallet = generateWallet(name, currency);
  return wallet;
};
